...
$f(x_1)\le f(x_2)$ for any $x_1<x_2$ in $D$ (strict if $f(x_1)<f(x_2)$).\\[6pt]
...
\textcolor{SeaGreen}{Examples:}
\begin{itemize}
\item \textbf{Price-demand curve} often decreasing on realistic intervals (then zero).
