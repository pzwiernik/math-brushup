...
\begin{minipage}{9.5cm}
	...
	\textbf{Five lectures:} today, Friday, Monday, Tuesday, Wednesday.\\[4mm]
...
\begin{itemize}
  \item \textbf{Indifference curves:} If a consumer is indifferent between two bundles, any convex combination is at least as good as one of them. This gives quasi-convex preferences.
...
\begin{tikzpicture}[remember picture,overlay]
  ...
  \node[inner sep=0,anchor=center,yshift=-0.07\paperheight] (bg) at (current page.center)
       {\includegraphics[scale=.7]{img/SFprogress0.png}};
...
\begin{itemize}
  ...
  \item \textbf{Isoelastic forms}: $u(x)=\tfrac{x^{1-\rho}-1}{1-\rho}$, common in growth models and risk analysis.
