...
### Announcements:
- Sep 9: Exercises for Wednesday: 7.14, 8.5, 8.6, 8.8 and 10.5.
- Sep 8: Exercises for Tuesday: 6.2, 6.4 (left from Monday), 6.6, 6.7, 6.8,  and maybe 7.6 depending on time.
...
| 4 | Systems of linear equations, eigenvalues and eigenvactors, spectral decomposition.  | [slides4](./slides/Lecture4.pdf) |  |  
| 5 | Quadratic forms, Multivariate functions, partial derivatives, differentiation, linear approximation.   | [slides5](./slides/Lecture5.pdf) |  |  
